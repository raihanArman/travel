                            ...
                            Row(
                              ...
                              children: <Widget>[
                                Container(
                                  width: 120.0,
                                  child: Text(
                                    activity.name, style: TextStyle(fontSize: 18.0, fontWeight: FontWeight.w600),
                                    maxLines: 2,
                            ...
                            Row(
                              children: <Widget>[
                                Container(
                                  ...
                                  child: Text(activity.startTimes[0], style: TextStyle(color: Colors.white),)
                                ),
                                SizedBox(width: 10.0,),
                                Container(
                                    padding: EdgeInsets.all(5.0),
                                    ...
                                    alignment: Alignment.center,
                                    child: Text(activity.startTimes[1], style: TextStyle(color: Colors.white),)
                                ),
                              ],
                            ),
                          ],
